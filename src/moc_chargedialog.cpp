...
struct qt_meta_stringdata_ChargeDialog_t {
    QByteArrayData data[1];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ChargeDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ChargeDialog_t qt_meta_stringdata_ChargeDialog = {
    {
QT_MOC_LITERAL(0, 0, 12) // "ChargeDialog"
...
QT_INIT_METAOBJECT const QMetaObject ChargeDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_ChargeDialog.data,
    qt_meta_data_ChargeDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ChargeDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ChargeDialog.stringdata0))
