...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ClientsDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ClientsDialog_t qt_meta_stringdata_ClientsDialog = {
    {
QT_MOC_LITERAL(0, 0, 13) // "ClientsDialog"
...
QT_INIT_METAOBJECT const QMetaObject ClientsDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_ClientsDialog.data,
    qt_meta_data_ClientsDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ClientsDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ClientsDialog.stringdata0))
